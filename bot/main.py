    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                ...
                WEEKLY_LEAVE_PERSONNEL: [MessageHandler(filters.TEXT & ~filters.COMMAND, haftalikizin_personnel)],
    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                ...
                WEEKLY_LEAVE_CANCEL_PERSONNEL: [MessageHandler(filters.TEXT & ~filters.COMMAND, haftalikiziniptal_personnel)],
